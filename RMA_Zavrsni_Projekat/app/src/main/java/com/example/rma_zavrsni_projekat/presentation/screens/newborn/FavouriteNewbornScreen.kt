...
@Composable
fun FavouriteNewbornScreen(
    viewModel: FavouriteNewbornViewModel,
                    ...
                    items(favourites) { fav ->
                        Card(
                            ...
                            Column(modifier = Modifier.padding(16.dp)) {
                                ...
                                InfoRow(label = "Male", value = fav.maleTotal.toString())
                                InfoRow(label = "Female", value = fav.femaleTotal.toString())
